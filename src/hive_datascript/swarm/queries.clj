...
;; Moved from hive-mcp.swarm.datascript.queries (via hive-agent).

(ns hive-datascript.swarm.queries
...
(defn- stale-threshold-ms
  "The host-installed stale threshold, else the 30-minute default."
  []
  (hooks/stale-threshold-ms))
